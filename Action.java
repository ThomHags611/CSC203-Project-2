...
/*TODO: what I can do is replace ActionKind with ActionTypes and for the constructor it takes ActionKind
   and initialize either activity or animation based on the input OR let user enter Activity or Animation
   wherever Action constructor is called*/

//TODO: main thing im confused with is we have to change paramaters when declaring action outside, is that okay?
