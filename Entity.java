...
public abstract class Entity{
    ...
    //TODO: STILL HAVE TO MOVE THE VARIABLES
   ...
   // public EntityKind getKind() {return this.kind;}
    ...
    //moved to BOTH Dudes(already fixed .kind)
...
//    }
    ...
    //this may be DUDE_FULL
//    public boolean moveToFull(WorldModel world, Entity target, EventScheduler scheduler) {
//        if (this.position.adjacent(target.position)) {
//            return true;
//        } else {
//            Point nextPos = ((Dude_Not_Full)this).nextPositionDude(world, target.position);
//
...
//    }
    ...
    //need to somehow incorporate Plant interface here
//    public boolean transformPlant(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
//        if(this instanceof Plant){
//            this.transformPlant(world, scheduler, imageStore);
//        }else {
...
//        this.health++;
//        if (!((Plant)this).transformPlant(world, scheduler, imageStore)) {
//            scheduler.scheduleEvent(this, Action.createActivityAction(this, world, imageStore), this.actionPeriod);
//        }
//    }
